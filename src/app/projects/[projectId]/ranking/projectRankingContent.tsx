...
export default function ProjectRankingContent({
  id,
  projectPath,
  name,
}: IProjectContent) {
  ...
  const handleGetMostPopularFileEntries = useCallback(async () => {
    setIsLoading(true);
  ...
  useEffect(() => {
    handleGetMostPopularFileEntries();
  }, [handleGetMostPopularFileEntries]);
